...
public class ThemeChooser {
    ...
    public void colorChanger(int dark,int light,int primary,int text,int accent,int primarytext,int secondarytext,int divider){
        ...
        //side navigation
        activity.findViewById(R.id.nav_quickmodes_back).setBackground(new ColorDrawable(activity.getResources().getColor(primary)));
        activity.findViewById(R.id.nav_quickmodes_card).setBackground(new ColorDrawable(activity.getResources().getColor(light)));
        activity.findViewById(R.id.session_history).setBackground(new ColorDrawable(activity.getResources().getColor(light)));
        activity.findViewById(R.id.nav_hishtory).setBackground(new ColorDrawable(activity.getResources().getColor(primary)));
        //options dialog
        optionDialog.findViewById(R.id.options_dialog_back).setBackgroundColor(activity.getResources().getColor(accent));
        //statusbar
